...
#ifndef RUNTIME_PLATFORM_ATOMIC_CTR_H_
#define RUNTIME_PLATFORM_ATOMIC_CTR_H_
...
#error This file should only be included on Nintendo 3DS builds.
#endif
...
#endif  // RUNTIME_PLATFORM_ATOMIC_CTR_H_
